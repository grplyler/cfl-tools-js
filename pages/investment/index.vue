          ...
          <div class="card">
            ...
            <div class="card-content">
              <div class="content" style="text-align: left;">
                ...
                <div class="field">
                  <label class="label">When do you plan to retire?</label>
                  <div class="control">
                    <input v-model="period_interest" class="input" type="text" />
                  </div>
                  <small>Enter an Age</small>
                </div>
                ...
                <div class="field">
                  ...
                  <!-- =FV(10%/12,(B5-B4)*12,-B6,0) -->
                  <!--  10000 * (1 + (0.10 / 12)) ^ (12 * 1) -->
